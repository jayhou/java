package jayhou.work.stringconvertion;

import jayhou.work.Log;

import java.io.UnsupportedEncodingException;

public class Words2Utf8Encoding {
    ...
    public static short[][] String2UTF_8_Encoding_uint16_Arrays(String[] strs) {
    ...
    public static void printShortAsHex4d(short[][] data) {
//        System.out.println("printShortAsHex4d start -------------");
        Log.d("Words2Encoding","printShortAsHex4d start -------------");
        if(data==null) return;
